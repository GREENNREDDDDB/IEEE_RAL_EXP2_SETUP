...
# 生成底面点云
    ...
    # 创建rgb-d-area
    rgbd_image_area = o3d.geometry.RGBDImage.create_from_color_and_depth(color, depth_area, convert_rgb_to_intensity=False)
    # 创建点云
...
# 生成每个实例点云和一个点云对象列表
    ...
    if result.masks is not None:
        ...
        for mask in masks:
            ...
            rgbd_image_object = o3d.geometry.RGBDImage.create_from_color_and_depth(color, depth_object, convert_rgb_to_intensity=False)
