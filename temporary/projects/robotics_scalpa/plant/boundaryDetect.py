...
def angle_criterion(pc_o3d: o3d.geometry.PointCloud):
    points = np.asarray(pc_o3d.points, dtype='float32')
    boundary_points = boundary_detection(points)

    boundary_pc = o3d.geometry.PointCloud()
    boundary_pc.points = o3d.utility.Vector3dVector(boundary_points)
